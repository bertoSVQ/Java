...
public class Cuadrado {
    ...
    public float VerValor_x2(){
        return (float) x2;
    }
    
    public float VerValor_y2(){
        return (float) y2;
    }
    ...
    public static Cuadrado suma(Cuadrado c1, Cuadrado c2){
        Cuadrado lasuma = new Cuadrado(); //Instancia sobre la que sí se puede 
                                          //invocar metodos no estáticos
        //this. no puede accederse a la referencia this
        lasuma.ModificarValores(c1.VerValor_x1() + c2.VerValor_x1(), 
                                c1.VerValor_y1() + c2.VerValor_y1(), 
                                c1.VerValor_x2() + c2.VerValor_x2(), 
                                c1.VerValor_y2() + c2.VerValor_y2(), 2);
        return lasuma;
    }
}
